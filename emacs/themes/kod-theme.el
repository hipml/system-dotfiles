(deftheme kod-theme
  "Kod theme with exact color matches from CSS definition")

(let ((class '((class color) (min-colors 89)))
      ;; Core colors - exact matches from CSS
      (bg "#222")
      (fg "#eee")
      (cursor-color "#ff3319")
      (selection-bg "#2F3F52")
      ;; Syntax colors - exact matches from CSS
      (comment-color "#666")
  ...
  (custom-theme-set-faces
   ...
   ;; Syntax highlighting - exact matches from CSS
   ...
   `(font-lock-constant-face ((,class (:foreground ,regexp-fg))))
   ...
   `(font-lock-warning-face ((,class (:foreground ,todo-color :weight bold))))
   ...
   ;; Diffs and version control - exact matches from CSS
   ...
   ;; Headers - matching CSS h1-h6 color
