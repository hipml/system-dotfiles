...
;; Use AUCTeX for .tex files
(add-to-list 'auto-mode-alist '("\\.tex\\'" . LaTeX-mode))

;; Enable RefTeX for citation management
(setq reftex-default-bibliography '("bibliography.bib"))
(setq reftex-plug-into-AUCTeX t)

;; Set the default LaTeX command
(setq latex-run-command "pdflatex")

;; Enable shell command completion for AUCTeX
(setq TeX-auto-save t)
(setq TeX-parse-self t)
(setq TeX-PDF-mode t)

;; Enable PDF mode to view PDF directly
(setq TeX-view-program-selection '((output-pdf "PDF Tools")))

;; Optionally, use the built-in PDF viewer
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(markdown-mode pdf-tools auctex flycheck-ocaml merlin-eldoc merlin tuareg tree-sitter-langs tree-sitter treesitter magit evil elpy ein)))
(custom-set-faces
